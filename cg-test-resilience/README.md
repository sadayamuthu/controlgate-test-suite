...
A test python project for cg-test-resilience containing intentionally vulnerable code to validate [ControlGate](https://github.com/sadayamuthu/controlgate).
